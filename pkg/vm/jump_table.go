...
// validate is called at init time (program startup) to catch
// configuration errors in the instruction set. These panics are
// acceptable — they fire before any user input is processed and
// indicate a programming error in the jump table definition.
