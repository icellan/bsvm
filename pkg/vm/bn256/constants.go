...
// Order is the number of elements in both G1 and G2: 36u^4+36u^3+18u^2+6u+1.
...
// P is a prime over which we form a basic field: 36u^4+36u^3+24u^2+6u+1.
...
// xiToPMinus1Over6 is xi^((p-1)/6) where xi = i+9.
...
// xiToPMinus1Over3 is xi^((p-1)/3) where xi = i+9.
...
// xiToPMinus1Over2 is xi^((p-1)/2) where xi = i+9.
